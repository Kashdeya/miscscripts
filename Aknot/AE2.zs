...
furnace.remove(<*>,<appliedenergistics2:tile.BlockSkyStone>);
mods.thermalexpansion.Furnace.removeRecipe(<appliedenergistics2:tile.BlockSkyStone>);
...
mods.botania.ElvenTrade.addRecipe(<appliedenergistics2:tile.BlockSkyStone:1>, [<appliedenergistics2:tile.BlockSkyStone>]);
