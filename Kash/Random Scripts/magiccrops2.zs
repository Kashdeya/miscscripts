...
val imagSeeds = <AgriCraft:seedImag>;
val maxOsmiumSeeds = <magicalcrops:magicalcrops_ModMagicSeedsOsmium>.withTag({strength: 10 as short, analyzed: 1 as byte, growth: 10 as short, gain: 10 as short});
...
val imagEssence = <Quadrum:imagEssence>;
...
val oreConstraint = <academy-craft:ac_Block_oreConstraintMetal>;
val resoCrystal = <academy-craft:ac_Item_resoCrystal>;
val lowImagCrystal = <academy-craft:ac_Item_crystalLow>;
val oreImagSilicon = <academy-craft:ac_Block_oreImagSil>;
val emptyUnit = <academy-craft:ac_Item_matterUnit>;
val phaseUnit = <academy-craft:ac_Item_matterUnit:1>;
...
//add Imag essence -> ore recipes
recipes.addShaped(oreConstraint * 2, [[imagEssence, imagEssence, imagEssence], [imagEssence, null, imagEssence], [imagEssence, imagEssence, imagEssence]]);
recipes.addShaped(resoCrystal * 2, [[null, imagEssence, null], [imagEssence, imagEssence, imagEssence], [null, imagEssence, null]]);
recipes.addShaped(lowImagCrystal * 2, [[null, imagEssence, null], [imagEssence, null, imagEssence], [imagEssence, imagEssence, imagEssence]]);
recipes.addShaped(oreImagSilicon * 2, [[null, imagEssence, imagEssence], [imagEssence, null, imagEssence], [imagEssence, imagEssence, null]]);
recipes.addShaped(phaseUnit, [[null, imagEssence, null], [imagEssence, emptyUnit, imagEssence], [null, imagEssence, null]]);
...
//imag seeds
Infuser.addRecipe("DIAMOND", 100, osmiumSeeds, imagSeeds);
Infuser.addRecipe("DIAMOND", 100, maxOsmiumSeeds, imagSeeds);
