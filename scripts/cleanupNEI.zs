...
NEI.hide(<AgriCraft:seedFerranium>);
NEI.hide(<AgriCraft:seedQuartzanthemum>);
NEI.hide(<AgriCraft:seedRedstodendron>);
NEI.hide(<AgriCraft:seedAurigold>);
NEI.hide(<AgriCraft:seedCuprosia>);
NEI.hide(<AgriCraft:seedJaslumine>);
NEI.hide(<AgriCraft:seedDiamahlia>);
NEI.hide(<AgriCraft:seedEmeryllis>);
NEI.hide(<AgriCraft:seedPetinia>);
NEI.hide(<AgriCraft:seedNitorWart>);
NEI.hide(<AgriCraft:seedOsmonium>);